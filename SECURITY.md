...
## Overview
This repository forms part of the UK Home Office Core Cloud Platform’s shared GitHub Actions tooling. It contains a reusable yarn audit composite GitHub Action used across the platform to maintain node code.
...
* validate the yarn reusable actions
...
* It will not be validated by the yarn audit action
